...
export class VehicleSpawnPoint implements ISpawnPoint {
    ...
    public spawn(loadingManager: LoadingManager, world: World): void {
        loadingManager.loadGLTF(
            ...
            (model: any) => {
                let vehicleOrNot: Vehicle | null = this.getNewVehicleByType(
                    model,
                    this.type
                )
                if (vehicleOrNot) {
                    let vehicle = vehicleOrNot
                    ...
                    console.warn(
                        'Aviso que el metodo getNewVehicleByType ha devuelto null, es decir, no ha encontrado ningun vehiculo'
                    )
                }
            }
        )
    ...
    private getNewVehicleByType(model: any, type: string): Vehicle | null {
        switch (type) {
            case 'car':
